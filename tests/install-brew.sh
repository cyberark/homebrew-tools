...
# This is from https://raw.githubusercontent.com/Homebrew/install/HEAD/install.sh
# Reproduced here to avoid curl|bash in a pipeline against a repo we don't control.
